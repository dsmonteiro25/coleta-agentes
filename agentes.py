...
class AgenteReativoSimples(Agent):
    ...
    def step(self):
        #Se estiver carregando um recurso, vai para a base. Caso contrário, explora.
...
class AgenteBaseadoEmEstado(Agent):
    def __init__(self, unique_id, model, base_pos):
        ...
        self.aguardando_ajuda = False  # Se encontrar uma estrutura, precisa de outro agente para transportar
    ...
    def step(self):
        ...
        if self.aguardando_ajuda:  #Se encontrou uma estrutura, aguarda por ajuda
            return  
